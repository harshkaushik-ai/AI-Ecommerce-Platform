    ...
    <div className="min-h-screen pt-20">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div >
            <div className="glass-card pb-4 mb-4">
              {product.images ?
            ...
            <div className="glass-card p-6 mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <button
                    ...
                    className="flex items-center active:scale-95 active:shadow-sm justify-center space-x-2 py-3 gradient-primary text-primary-foreground rounded-lg hover:glow-on-hover animate-smooth font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                  ...
                  <button
                    ...
                    disabled={product.stock === 0}
                    className=" flex items-center justify-center gap-2 py-3 bg-secondary active:scale-95 active:shadow-sm text-foreground border border-border rounded-lg hover:bg-accent animate-smooth font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
                  >
